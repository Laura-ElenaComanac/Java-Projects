...
import repository.AgencyUserDBRepository;
...
public class ThriftServer implements ThriftService.Iface{
    private AgencyUserDBRepository agencyUserRepository;
    ...
    public ThriftServer(AgencyUserDBRepository agencyUserRepository, TripDBRepository tripRepository, ReservationDBRepository reservationRepository) {
